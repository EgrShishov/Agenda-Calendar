...
const CalendarHeader = () => {
    return (
        <header className="px-4 py-2 flex items-center border border-gray-200 rounded-md shadow-sm">
            <img src={logo} alt={"calendar"} className="mr-4 w-12 h-12"/>
            <p className="text-3xl font-bold text-orange-400 mr-2">
                Agenda
            </p>
            <p className="text-3xl font-bold text-gray-400 mr-10">
                Calendar
            </p>
